...
(function () {
  ...
  function injectStyles() {
    ...
    css.textContent = [
      ...
      /* Zelfde maten en tekstbehandeling als elke andere knop; zie knop.css. */
      '.fd-cc-btn{flex:1 1 auto;min-width:150px;display:inline-flex;align-items:center;justify-content:center;',
      'height:var(--fd-knop-h-m,48px);padding:0 var(--fd-ruimte-5,24px);box-sizing:border-box;',
      'border-radius:var(--fd-hoek-knop,999px);border:1px solid transparent;cursor:pointer;',
      'font-family:inherit;font-weight:700;font-size:var(--fd-tekst-s,.875rem);line-height:1;',
      'letter-spacing:0;text-transform:none;transition:all .22s ease}',
      ...
      '.fd-cc-reject{background:rgba(16,16,20,.043);color:#101014;border-color:rgba(16,16,20,.18)}',
